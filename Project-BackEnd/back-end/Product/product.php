                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="row justify-content-between">
                            <div class="col-md-5">
                                ...
                                <div class="py-2">
                                    <a class="btn btn-info text-white" href="product_edit.php?vendor_id=<?= $vendor_id ?>&id=<?= $row["id"] ?>">編輯</a>
                                    <a class="btn btn-danger" href="product_delete.php?vendor_id=<?= $vendor_id ?>&id=<?= $row["id"] ?>">刪除</a>
                                </div>
                            </div>
                            <div class="col-md-5 text-end">

                                <a class="btn btn1 text-white" href="product_vendor_list.php?vendor_id=<?= $vendor_id ?>">取消</a>
                            </div>
                        </div>
                    </div>
                </div>
